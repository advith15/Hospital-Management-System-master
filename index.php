...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp RVCE Healthcare</h4></a>
  ...
  <a class="nav-link js-scroll-trigger" href="https://heroic-gnome-206efc.netlify.app/" target="_blank" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>CHAT WITH US</h6></a>
</li>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <h2><br><br>RVCE Healthcare Management System</br></br></h2>
